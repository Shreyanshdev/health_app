...
export function DoctorSidebar({ onCollapseChange, mobileOpen = false, onMobileClose }: DoctorSidebarProps) {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between h-14 md:h-16 bg-white border-b border-gray-200 px-3">
        {!isCollapsed && (
          <Link href="/doctor/dashboard" className="flex items-center space-x-2 text-lg font-bold text-gray-900 hover:text-blue-600 transition cursor-pointer">
